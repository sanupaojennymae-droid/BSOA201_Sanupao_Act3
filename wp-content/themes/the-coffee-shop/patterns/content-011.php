...
/**
 * Title: Content 011
 * Slug: the-coffee-shop/content-011
 * Categories: teams
 */
?>
...
<h2 class="wp-block-heading has-text-align-left has-contrast-color has-text-color has-superbfont-xlarge-font-size" style="font-style:normal;font-weight:300">We Serve The Best Coffee<br> You'll Ever Have.</h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-left has-contrast-color has-text-color has-superbfont-medium-font-size">BREAKFAST & BRUNCH</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-left has-contrast-color has-text-color" style="font-size:24px">FRESH COFFEE</h3>
<!-- /wp:heading --></div>
<!-- /wp:group -->
